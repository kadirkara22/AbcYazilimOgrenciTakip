...
namespace AbcYazilim.OgrenciTakip.UI.Win.Functions
{
   public static class GeneralFunctions
    {   
        ...
        public static void ButtonEnebledDurumu<T>(BarButtonItem btnYeni,BarButtonItem btnKaydet,BarButtonItem btnGeriAl,BarButtonItem btnSil, T oldEntity,T currentEntity)
        {
            var veriDegisimYeri = VeriDegisimYeriGetir(oldEntity, currentEntity);
            var butonEnebledDurumu = veriDegisimYeri == VeriDegisimYeri.Alan;

            btnKaydet.Enabled = butonEnebledDurumu;
            btnGeriAl.Enabled = butonEnebledDurumu;
            btnYeni.Enabled =! butonEnebledDurumu;
            btnSil.Enabled = !butonEnebledDurumu;
        }
